...
var CErrFileTooLarge = errors.New("file is too large. (max. 5MB)")
var CErrInvalidExt = errors.New("disallowed file extension.")
var CErrInvalidMIME = errors.New("disallowed file MIME type.")
...
var (
	...
	ErrChildNodeExists   = AppError{400, "E400_004", "하위 항목이 존재하여 삭제할 수 없습니다."}
	...
	ErrAlreadyExist      = AppError{409, "E409_002", "이미 기존 리소스가 존재하여 생성할 수 없습니다."}
