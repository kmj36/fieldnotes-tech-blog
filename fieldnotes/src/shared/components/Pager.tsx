...
export default function Pager({ meta, onChange }: Readonly<PagerProps>) {
    ...
    return (
        <div style={{ display: "flex", gap: "4px", justifyContent: "center", padding: "1.5rem 0", alignItems: "center" }}>
            ...
            {lo > 1 && (
                <>
                    <button onClick={() => onChange(1)} style={{ background: "none", border: "none", fontFamily: FM, fontSize: ".8rem", padding: "4px 8px", cursor: "pointer", color: C.muted }}>1</button>
            ...
            {hi < totalPages && (
                <>
                    <span style={{ color: C.muted }}>…</span>
                    <button onClick={() => onChange(totalPages)} style={{ background: "none", border: "none", fontFamily: FM, fontSize: ".8rem", padding: "4px 8px", cursor: "pointer", color: C.muted }}>{totalPages}</button>
                </>
            )}
